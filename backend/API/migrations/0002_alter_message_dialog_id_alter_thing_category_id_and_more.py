...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='message',
            name='dialog_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.dialog'),
        ),
        migrations.AlterField(
            model_name='thing',
            name='category_id',
        ...
        migrations.AlterField(
            model_name='trade',
            name='feedback_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.feedback'),
        ),
        migrations.AlterField(
            model_name='trade',
            name='thing_id',
